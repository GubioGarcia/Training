...
namespace Training.Data.Migrations
{
    ...
    [Migration("20250114233852_Added starting tables related to exercises and training")]
    partial class Addedstartingtablesrelatedtoexercisesandtraining
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Training.Domain.Entities.ClientProfessional", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DescriptionProfessional")
                        .IsRequired()
                        .HasMaxLength(500)
                    ...
                    b.ToTable("ClientProfessionals");
                });

            modelBuilder.Entity("Training.Domain.Entities.Exercise", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Training.Domain.Entities.MuscleGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Training.Domain.Entities.PeriodizationTraining", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PeriodizationTraining");
                });
            ...
            modelBuilder.Entity("Training.Domain.Entities.Training", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PeriodizationId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PeriodizationTrainingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PeriodizationTrainingId");
            ...
            modelBuilder.Entity("Training.Domain.Entities.WorkoutCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Training.Domain.Entities.ClientProfessional", b =>
                {
                    b.HasOne("Training.Domain.Entities.Client", "Client")
                        .WithMany("ClientProfessionals")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Training.Domain.Entities.Professional", "Professional")
                        .WithMany("ClientProfessionals")
            ...
            modelBuilder.Entity("Training.Domain.Entities.Exercise", b =>
                {
                    b.HasOne("Training.Domain.Entities.MuscleGroup", "MuscleGroup")
                        .WithMany()
                    ...
                    b.HasOne("Training.Domain.Entities.WorkoutCategory", "WorkoutCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Training.Domain.Entities.PeriodizationTraining", b =>
                {
                    b.HasOne("Training.Domain.Entities.Client", "Client")
                        .WithMany("PeriodizationTrainings")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Training.Domain.Entities.Training", b =>
                {
                    b.HasOne("Training.Domain.Entities.PeriodizationTraining", "PeriodizationTraining")
                        .WithMany("Trainings")
                        .HasForeignKey("PeriodizationTrainingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Training.Domain.Entities.Professional", null)
                        .WithMany("Trainings")
                        .HasForeignKey("ProfessionalId");

                    b.Navigation("PeriodizationTraining");
                });

            modelBuilder.Entity("Training.Domain.Entities.WorkoutCategory", b =>
                {
                    b.HasOne("Training.Domain.Entities.Professional", "Professional")
                        .WithMany("WorkoutCategorys")
                        .HasForeignKey("ProfessionalId");
            ...
            modelBuilder.Entity("Training.Domain.Entities.Client", b =>
                {
                    ...
                    b.Navigation("PeriodizationTrainings");
                });
