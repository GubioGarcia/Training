...
namespace Training.Data.Migrations
{
    ...
    [Migration("20250907164220_UpdatePeriodizationModel")]
    partial class UpdatePeriodizationModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Training.Domain.Entities.Periodization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Training.Domain.Entities.PeriodizationTraining", b =>
                {
                    b.HasOne("Training.Domain.Entities.Periodization", "Periodization")
                        .WithMany("PeriodizationTrainings")
                        .HasForeignKey("PeriodizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Training.Domain.Entities.Training", "Training")
                        .WithMany("PeriodizationTrainings")
